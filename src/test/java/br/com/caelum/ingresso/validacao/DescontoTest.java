...
import br.com.caelum.ingresso.desconto.DescontoEstudando;
...
public class DescontoTest {
	...
	public void deveConcederDescontoDe30PorCentoParaIngressosDeClienteDeBancos(){
		 ...
		 Filme filme = new Filme("NOme",Duration.ofMinutes(120),"Sifi",new BigDecimal("12.0"));
	...
	@Test
	public void desconto50PorcentoEstudante(){
		Sala sala = new Sala("",new BigDecimal("20.5"));
		 Filme filme = new Filme("NOme",Duration.ofMinutes(120),"Sifi",new BigDecimal("12.0"));
		 
		 Sessao sessao = new Sessao(LocalTime.parse("10:00:00"),filme,sala);
		 Ingresso ingresso = new Ingresso(sessao,new DescontoEstudando());
